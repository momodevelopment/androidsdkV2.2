...
public class MoMoConfig {
    ...
    public static final String MOMO_APP_PAKAGE_CLASS_DEVELOPER = "vn.momo.platform";// App Test ver 3.0.12 or newest using id "vn.momo.platform", App Test ver 3.0.11 or lower using id "com.mservice";
